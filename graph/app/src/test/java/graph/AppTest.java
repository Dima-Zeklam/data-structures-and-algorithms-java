...
class AppTest {
    ...
    @Test void TestDebthFirst() {
        ...
        assertEquals("[A, B, C, D, F, H, E]",graph2.depthFirst("A").toString());
    }
    @Test void TestDebthFirstInEmptyGraph() {
        Graph<String> graph2 = new Graph();

        assertEquals(null,graph2.depthFirst(null));
    }
